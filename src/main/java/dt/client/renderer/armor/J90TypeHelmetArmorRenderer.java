...
import dt.client.model.armor.J90TypeHelmetModel;
...
public class J90TypeHelmetArmorRenderer extends GeoArmorRenderer<J90TypeHelmetItem> {
    public J90TypeHelmetArmorRenderer() {
        super(new J90TypeHelmetModel());
