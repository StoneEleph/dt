...
import dt.client.model.armor.M1HelmetModel;
...
public class M1HelmetArmorRenderer extends GeoArmorRenderer<M1HelmetItem> {
    public M1HelmetArmorRenderer() {
        super(new M1HelmetModel());
